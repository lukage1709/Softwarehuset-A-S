...
Scenario: Change date of project
   	...
   	When the teamleader sets startdate "05" "2018" and enddate "25" "2018" to the project
    	Then the startdate of the project is set to "Week:05, Year:2018" and the enddate of the project is set to "Week:25, Year:2018"
