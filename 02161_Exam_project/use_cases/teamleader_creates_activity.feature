...
Scenario: Teamleader selects a start week that is after the end week
	...
	And this project has a teamleader with id "Anje"
	And the teamleader is logged in
	When teamleader wrongly adds activity named "Activity 1", estimatedhours 20, startweek "2018-5" and endweek "2018-2" to the project
	Then I get an error message "The activity cannot end before it starts"
	
Scenario: Teamleader selects a start week that is before the project starts
	Given that there is a project with the name "Test Project" that starts "2018-6"
	And this project has a teamleader with id "Anje"
	And the teamleader is logged in
	When teamleader wrongly adds activity named "Activity 1", estimatedhours 20, startweek "2018-5" and endweek "2018-8" to the project
	Then I get an error message "The activity cannot start before the project starts"
